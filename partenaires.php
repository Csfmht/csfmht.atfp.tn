  ...
  if (!empty($_POST))
    {
        ...
        if ($user)
            { if($user-> role === "Part" or $user-> role === "Admin")
              {
                header('Location: Partenaire.php?login=1');
                exit();
              }
              else
              {
...
<html style="font-size: 16px;">
    <head>
        ...
        <meta property="og:title" content="Partenaires_الشركاء">
        <meta property="og:type" content="website">
        <meta name="theme-color" content="#478ac9">
        <meta property="og:url" content="index.php">
   
        <title>Partenaires_الشركاء</title>
    ...
    <body class="u-body">
      ...
      <!----------------------##############--------------------- Fenêtre de connexion ----------------------##############--------------------->                
                        ...
                        <div class="u-form u-form-1">
                            <form id="FormConnexion" name="FormConnexion" method="POST" action="">
                                ...
                                <div class="p-2 u-align-center u-form-group u-form-submit u-form-group-3">
                                    <input type="submit" name="validconnectPart" id="validconnectPart" class="btn btn-success" value="se connecter" />
                                </div>
                            </form>
                            <?php if($error===1): ?>
                                <div class="alert alert-danger u-align-center u-form-group u-form-submit u-form-group-4">
                                    <h3 class="u-custom-font u-font-oswald u-text u-text-1" id="titreconnect">
                                        <FONT size="2">Désolé, vous n'êtes pas un partenanire</FONT><br>
                                        <FONT size="3">نتأسف أنت ليس بمؤسسة شريكة</FONT>
                                    </h3>
                                </div>
                            <?php endif ?>
            ...
            <div class="modal-body">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam voluptates excepturi sint, veritatis officia laborum temporibus. Beatae neque reprehenderit ipsum numquam facilis repudiandae iste explicabo voluptatum corrupti harum. Sunt, asperiores.
            </div>
